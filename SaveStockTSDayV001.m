function [SaveLog,ProbList,NewList] = SaveStockTSDayV001(StockList,AdjFlag,XRDFlag)
%%6月3日更新,数据来源变更为wind信息,提高速度和准确率,工程并不紧迫.
% by LiYang_faruto
...
for i=1:Len
StockCode{i} = [StockList{i,2}(3:end),'.',StockList{i,2}(1:2)];
end
